...
struct scm *scm_open(const char *pathname, int truncate)
{
  ...
  /* Initialize the scm with zeros */
  /** Not sure exactly what is meant by this... the members are going to be init'd anyway. **/
  /** Maybe setting everything within the available memory to zero? **/
